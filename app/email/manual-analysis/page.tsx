...
const mockTopics = [
  { id: 1, name: "Inbox Issues", subtopics: [
    { id: 11, name: "Spam Detection", keywords: ["spam", "filter", "junk"] },
    { id: 12, name: "Attachment Problems", keywords: ["attachment", "file", "error"] },
  ] },
  { id: 2, name: "Delivery Problems", subtopics: [
    { id: 21, name: "Delayed Email", keywords: ["delay", "late", "delivery"] },
    { id: 22, name: "Bounce Back", keywords: ["bounce", "undelivered"] },
  ] },
];

const EmailManualAnalysisPage = () => {
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">Email Manual Analysis</h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Manage, merge, and map topics and subtopics for emails. (UI Mockup)
              </p>
            </div>
...
export default EmailManualAnalysisPage;
