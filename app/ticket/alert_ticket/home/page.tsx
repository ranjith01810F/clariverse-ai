        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">Alert Ticket Dashboard</h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Interactively analyze alert ticket data with advanced visualizations and topic modeling insights.
              </p>
            </div>
            {/* Placeholder for alert ticket dashboard content */}
            <div className="bg-gray-800 rounded-lg p-8 shadow-lg text-center text-gray-400 italic">
              [Alert ticket dashboard content will appear here]
            </div>
          </div>
        </section>
      </div>
...
export default AlertTicketHomePage;
