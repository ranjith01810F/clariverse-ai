...
const mockTopics = [
  { id: 1, name: "Bot Issues", subtopics: [
    { id: 11, name: "Bot Not Responding", keywords: ["bot", "no reply", "timeout"] },
    { id: 12, name: "Wrong Answer", keywords: ["incorrect", "answer", "response"] },
  ] },
  { id: 2, name: "User Experience", subtopics: [
    { id: 21, name: "Slow Response", keywords: ["slow", "delay", "lag"] },
    { id: 22, name: "UI Glitch", keywords: ["glitch", "ui", "bug"] },
  ] },
];

const ChatManualAnalysisPage = () => {
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">Chat Manual Analysis</h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Manage, merge, and map topics and subtopics for chats. (UI Mockup)
              </p>
            </div>
...
export default ChatManualAnalysisPage;
