        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">Chat Topic Analysis</h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Explore and filter chat topics and subtopics to gain actionable insights.
              </p>
            </div>
            {/* Placeholder for chat topic analysis content */}
            <div className="bg-gray-800 rounded-lg p-8 shadow-lg text-center text-gray-400 italic">
              [Chat topic analysis content will appear here]
            </div>
          </div>
        </section>
      </div>
